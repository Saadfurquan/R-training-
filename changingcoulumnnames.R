...
#replacing NA(not available) Values
person.finaldata[is.na (person.finaldata)]="2050-01-04"
print(person.finaldata)
#changing column name
colnames(person.finaldata)[which(names(person.finaldata)=="person_id")]="down _in_marks_of_history"
print(person.finaldata)
